...
function App() {
  ...
  React.useEffect(() => {
    axios.get('https://640f1d3b4ed25579dc4636a2.mockapi.io/items').then((res) => {
      setItems(res.data);
    });
    axios.get('https://640f1d3b4ed25579dc4636a2.mockapi.io/cart').then((res) => {
      setCartItems(res.data);
    });
    axios.get('https://640f1d3b4ed25579dc4636a2.mockapi.io/favorites').then((res) => {
